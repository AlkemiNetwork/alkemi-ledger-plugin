...
//   unsignedTx.value = parseEther("0.1");
  ...
  await sim.navigateAndCompareSnapshots('.', 'nanos_perform_a_supply', [3, 0]);
...
// NanoX test
// EDIT THIS: build your own test
test('[Nano X] Perform a supply', zemu("nanox", async (sim, eth) => {
  ...
  await sim.navigateAndCompareSnapshots('.', 'nanox_perform_a_supply', [3, 0]);
